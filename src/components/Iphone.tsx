...
/* PNG → viewBox placement. The bitmap is 873×1530 with the chassis at
   ...
   viewBox x=200, and IMG_Y rests the foot on the desk at viewBox y≈580. */
const IMG_X = 45.9;
const IMG_Y = 62;
...
/* Screen glass in viewBox coords — a touch larger than the bitmap's white
   screen (which lands at ≈90.9..309.4 × 125.7..515.5) so no white halo
   peeks out. Centred at (200,321). */
const GLASS_X = 89;
const GLASS_Y = 124;
const GLASS_W = 222;
const GLASS_H = 394;
const GLASS_CX = GLASS_X + GLASS_W / 2; // = 200
const GLASS_CY = GLASS_Y + GLASS_H / 2; // = 321
...
export default function Iphone({
  ...
  return (
    ...
    >
      ...
      <ellipse cx="200" cy="540" rx="220" ry="115" fill="url(#ipDeskPool)" />
